...
public class LoginDialog extends JDialog {
    ...
    private JPanel createGUI() {
        ...
        BoxLayoutUtils.setGroupAlignmentY(Component.CENTER_ALIGNMENT, nameField, passwrdField, nameLabel, passwrdLabel);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new LoginDialog(new JFrame()));
    }
}
